<template>
<!-- clean flash from controller!-->
 <span v-if="!show">{{ $page.props.flash.notice = '', $page.props.flash.alert = '', show = true }} </span>

  <div v-if="show">
    <div v-if="$page.props.flash.notice" class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
    ...
    <div v-if="Object.keys($page.props.errors).length" class="bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
      <div class="flex relative">
